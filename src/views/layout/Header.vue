<template>
    <div class="wrapper c-flex-between c-pl10">
        ...
        <section class="c-flex-ycenter">
            ...
            <div class="c-flex-ycenter c-mx10" @mouseover="changeColor('color3')" @mouseout="restoreColor('color3')">
            ...
            <div class="c-flex-ycenter c-mx10" @mouseover="changeColor('color4')" @mouseout="restoreColor('color4')">
