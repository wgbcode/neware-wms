  ...
  <div class="c-flex-between c-pl10">
    ...
    <section class="c-flex-ycenter">
      <div
        ...
        @mouseover="changeColor('color2')"
        @mouseout="restoreColor('color2')"
        @click="toggleTheme()"
      >
      ...
      <div
        class="c-flex-ycenter c-mx10"
        @mouseover="changeColor('color3')"
        @mouseout="restoreColor('color3')"
      >
        <Icon name="refresh-page" :color="color.color3" size="20px" class="c-mr5" />
        <span class="c-mt2 c-fs14 c-cwhite c-forbidSelect" :style="{ color: color.color3 }"
          >刷新页面</span
        >
      </div>
      <div
        class="c-flex-ycenter c-mx10"
        @mouseover="changeColor('color4')"
